...
// EmailJS config
const EMAILJS_SERVICE_ID  = 'service_mlbwctj';
const EMAILJS_TEMPLATE_ID = 'template_fnt4918';
const EMAILJS_PUBLIC_KEY  = 'JfAo06rbjleEBq0Cl';
...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      url: 'https://linkedin.com/in/ermiyas-girma',
      label: 'LinkedIn',
      delay: 0.2,
    },
  ];
